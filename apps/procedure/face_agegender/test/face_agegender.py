...
class AgeGender:
    def __init__(self):
        ...
        self.modelfullpath= djangosqlite_db.Dbmgr().agegender_modelpath #"/home/pi/visio/procs/face_agegender/agegender_model/" 
    ...
    def video_detector(self, age_net, gender_net):
      ...
      firstname = djangosqlite_db.Dbmgr().agegen_user
    ...
    #detect faces from an image. Params: grayscale image, scaleFactor, minNeighbors
        ...
        for (x, y, w, h )in faces:
          ...
          #age value???
          djangosqlite_db.Dbmgr().insert_person_emotion(firstname, lastname, 
...
#    video_detector(age_net, gender_net)
    def video_detector2(self, age_net, gender_net):
