# Generated by Django 3.2.6 on 2022-04-09 08:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camera', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='visio.camera')),
            ],
        ),
        migrations.CreateModel(
            name='Person',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='visio.entity')),
                ('person', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='visio.person')),
            ],
        ),
        migrations.CreateModel(
            name='ImageData',
